djapi-todo - A ToDo API built with the Django REST framework
===============================================================
...
basic functionality using todo lists.
...
----------------------------------------
`kbowen-djapi-todo <https://kbowen-djapi-todo.herokuapp.com/>`_
