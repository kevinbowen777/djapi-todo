...
A basic todo/task tracking website & API built with Django 5.1.x & Django REST Framework (DRF) 3.13.x
 ...
 * Dev/testing
   ...
   * `Nox <https://pypi.org/project/nox/>`_ testing sessions for latest Python 3.10, and 3.11, 3.12, 3.13
...
Installation
------------
To install the djapi-todo project,
...
To run djapi-todo, locally, enter the following on the command line:
...
Visit the djapi-todo `Issues page <https://github.com/kevinbowen777/djapi-todo/issues>`_ on GitHub.
